---
title: "What happens if we write good tests?"
description: 'Channel your resources away from manual testing to delivering value.'
pubDate:  'Nov 24 2024'
tags: ["r", "tests"]
---
...
import image from './cost-testing_good.svg';
