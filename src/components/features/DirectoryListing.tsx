      ...
      {directories.map((dir, index) => {
        ...
        return (
          <div
            ...
            className={cn(
              "col-[1/-1]",
              isLeft ? "md:col-[1/5] lg:col-[1/7]" : "md:col-[5/-1] lg:col-[7/-1]",
            )}
          ...
          >
            <NotebookLinkCard
              ...
              body={
                <div
                  className="text-muted-foreground text-sm leading-relaxed line-clamp-5 group-hover/post:line-clamp-none transition-all duration-300"
                  dangerouslySetInnerHTML={{
              ...
              meta={
                <CardMetaRow className="pt-4">
                  ...
                  <span className="ml-auto uppercase">{dir.name.replace(/-/g, " ")}</span>
                </CardMetaRow>
              }
              actions={
                <>
                  <Button size="sm" asChild>
                    <a href={`/r-tests-gallery/${dir.name}`}>Browse</a>
                  </Button>
